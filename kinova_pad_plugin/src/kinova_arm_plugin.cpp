#include <kinova_pad_plugin/kinova_arm_plugin.h>
...
void PadPluginKinovaArm::initialize(const ros::NodeHandle& nh, const std::string& plugin_ns)
{
  ...
  pad_status_pub_ = pnh_.advertise<kinova_pad_msgs::KinovaArmStatus>("status", 10);
  ...
  arm_status_msg_ = kinova_pad_msgs::KinovaArmStatus();
}
